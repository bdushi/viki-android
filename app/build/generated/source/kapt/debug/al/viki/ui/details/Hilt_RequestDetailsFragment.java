...
public abstract class Hilt_RequestDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RequestDetailsFragment() {
    super();
  }

  Hilt_RequestDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RequestDetailsFragment_GeneratedInjector) this.generatedComponent()).injectRequestDetailsFragment(UnsafeCasts.<RequestDetailsFragment>unsafeCast(this));
    }
  }
