...
public abstract class Hilt_RequestNewAccountFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RequestNewAccountFragment() {
    super();
  }

  Hilt_RequestNewAccountFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RequestNewAccountFragment_GeneratedInjector) this.generatedComponent()).injectRequestNewAccountFragment(UnsafeCasts.<RequestNewAccountFragment>unsafeCast(this));
    }
  }
