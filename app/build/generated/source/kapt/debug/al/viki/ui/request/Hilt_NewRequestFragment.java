...
public abstract class Hilt_NewRequestFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NewRequestFragment() {
    super();
  }

  Hilt_NewRequestFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewRequestFragment_GeneratedInjector) this.generatedComponent()).injectNewRequestFragment(UnsafeCasts.<NewRequestFragment>unsafeCast(this));
    }
  }
