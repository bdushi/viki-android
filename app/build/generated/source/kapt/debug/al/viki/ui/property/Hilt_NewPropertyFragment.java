...
public abstract class Hilt_NewPropertyFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NewPropertyFragment() {
    super();
  }

  Hilt_NewPropertyFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewPropertyFragment_GeneratedInjector) this.generatedComponent()).injectNewPropertyFragment(UnsafeCasts.<NewPropertyFragment>unsafeCast(this));
    }
  }
