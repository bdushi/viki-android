...
public abstract class Hilt_PropertyDetailsFragment<T extends ViewDataBinding> extends DetailsFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PropertyDetailsFragment_GeneratedInjector) this.generatedComponent()).injectPropertyDetailsFragment(UnsafeCasts.<PropertyDetailsFragment>unsafeCast(this));
    }
  }
